      ...
      <div className="container mx-auto flex flex-col lg:flex-row gap-y-3 justify-between items-center">
        ...
        <div className="flex gap-x-8 items-center">
          ...
          <div className="flex gap-x-3 items-center">
            ...
            <div className="text-white">
              <div className="font-robotoCondensed uppercase font-medium leading-none text-sm">
                24/7 Medicine delivery service
              </div>
          ...
          >
            ...
            {/* amount */}
            <div className="bg-tertiary w-6 h-6 rounded-full text-white flex justify-center text-[13px] font-robotoCondensed absolute -bottom-2 -right-1">
              {itemAmount}
            </div>
          </div>
        </div>
